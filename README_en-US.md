...
<div>
    <img alt="license" src="https://img.shields.io/github/license/taojy123/LingV1.0">
    <img alt="language" src="https://img.shields.io/badge/python-%3E%3D%203.7-green">
    <img alt="stars" src="https://img.shields.io/github/stars/taojy123/LingV1.0?style=social">
</div>
<div>
    <a href="https://deepwiki.com/taojy123/LingV1.0">
...
This program is written in `Python` and packed as executable file. You can download [release version](https://github.com/taojy123/LingV1.0/releases) directly without installation of Python.
...
- (Windows) pyinstaller -F -w --add-data "./assets;assets" LingV1.0.py
- (Linux X11) pyinstaller -F -w --add-data "./assets:assets" --hidden-import "pynput.keyboard._xorg" --hidden-import "pynput.mouse._xorg" LingV1.0.py
- (Linux Wayland) pyinstaller -F -w --add-data "./assets:assets"  --hidden-import "pynput.keyboard._uinput" --hidden-import "pynput.mouse._uinput" LingV1.0.py
- (MacOS) pyinstaller -F -w --add-data "./assets:assets" --hidden-import "pynput.keyboard._darwin" --hidden-import "pynput.mouse._darwin" LingV1.0.py
```
...
Run specific script
```
> ./LingV1.0 scripts/0314_1452.txt
```

Run specific script for 3 times
```
> ./LingV1.0 scripts/0314_1452.txt -rt 3
> ./LingV1.0 scripts/0314_1452.txt --runtimes 3
```
...
Please check [wiki](https://github.com/taojy123/LingV1.0/wiki/Document#grammar)
...
[![Contributors](https://contrib.rocks/image?repo=taojy123/LingV1.0)](https://github.com/taojy123/LingV1.0/graphs/contributors)


If you are a developer and interested in this project, you can check the progress in branch [**dev**](https://github.com/taojy123/LingV1.0/tree/dev). and you are welcomed to participating by opening pull request to branch [**dev**](https://github.com/taojy123/LingV1.0/tree/dev).

Thanks to free develop tool provided by JetBrains

<a href="https://www.jetbrains.com/?from=LingV1.0"><img src="https://raw.githubusercontent.com/taojy123/LingV1.0/master/jetbrains-variant-2.png" height="80"></a>
