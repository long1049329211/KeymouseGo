...
+ 快捷键支持鼠标中键与侧键
+ 相关 issue 提出的功能需求实现
+ 4.0 代码基本由 <a href="https://github.com/Monomux">Monomux</a> 贡献，LingV1.0 的整体品质有了较大提升。感谢付出！
...
针对这个 issue(https://github.com/taojy123/LingV1.0/issues/39) 增加了两个功能点
...
https://github.com/taojy123/LingV1.0/issues/24
https://github.com/moses-palmer/pynput/issues/55

+ 改回使用 `win32api` 来模拟事件，只支持 windows 系统
+ 解决了 `shift` + `上下左右` 的回放问题，见 https://github.com/taojy123/LingV1.0/issues/27
+ 增加了录制鼠标路径功能，需求来源 https://github.com/taojy123/LingV1.0/issues/33
+ 增加了文字输入功能，需求来源 https://github.com/taojy123/LingV1.0/issues/34
